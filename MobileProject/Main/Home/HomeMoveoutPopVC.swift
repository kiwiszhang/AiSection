...
@objc protocol HomeMoveoutPopVCDelegate: AnyObject {
    func updateTableViewData()
}

class HomeMoveoutPopVC: SuperViewController {
    weak var delegate: HomeMoveoutPopVCDelegate?
...
extension HomeMoveoutPopVC:PopTopViewDelegate {
...
extension HomeMoveoutPopVC:HomeAddFloderPopVCDelegate {
...
extension HomeMoveoutPopVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.row == 0 {
            ...
            recordingItem?.recordFolder = ""
            recordingItem?.recordFolderId = ""
            try! RecordingItemStore.shared.updateRecordingItem(recordingItem!)
            dismissAction?()
